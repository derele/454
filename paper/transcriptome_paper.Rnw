...
\Sexpr{nrawFrame[[1]]} at codon first positions, \Sexpr{nrawFrame[[2]]}
at second positions and \Sexpr{nrawFrame[[3]]} at third positions. As
...
align(the.tab) <- "llllp{3cm}p{3cm}rrrrrrrrrrr"
