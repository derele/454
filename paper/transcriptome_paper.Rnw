...
\Sexpr{cn(nMN)} contigs supported by both assembly algorithms,
\Sexpr{cn(nbad.c)} contigs supported by only one of the assembly
algorithms and \Sexpr{cn(nSing)} singletons that not assembled by
...
trim_mark$source.p <- c("Europe Rhine", "Europe Poland", "Europe Rhine",
                       "Asia cultured", "Asia cultured", "Asia wild")
