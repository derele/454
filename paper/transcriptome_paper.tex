...
\begin{abstract}
  ...
  confidence (lowCA) assembly (spanning an additional 6.2 Mb). Roughly
  55\% of the highCA derived contigs could be annotated with domain-
  or protein sequence similarity match-derived functional
