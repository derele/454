...
+     geom_bar(position = "dodge") + scale_x_discrete(breaks = sum.annot$description, label = gsub("and\nnucleic\nacid\nmetabolic\nprocess", 
+     "and nucleic acid\nmetabolic process", gsub(" ", "\n", sum.annot$description))) + facet_wrap(~ontology, 
+     ncol = 1, scales = "free") + opts(legend.text = theme_text(face = "italic"))
...
(317782 uniqe) tags did not map to any sequence in the
fullest assembly.
...
25 sequences being significatnly
...
adjacent to homoploymer regions from 0.45 to
