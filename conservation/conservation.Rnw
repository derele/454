                             ...
                             ifelse(contig.df$conserved.clade.50%in%TRUE &
                                    ...
                                    ifelse(contig.df$conserved.clade.50%in%TRUE &
                                           ...
                                           ifelse(contig.df$conserved.clade.50%in%FALSE &
                                                  ...
                                                  contig.df$conserved.kingdom.50%in%FALSE,
                                                  "novel.in.clade3",
                                                  ifelse(is.na(contig.df$conserved.clade.50) &
                                                         is.na(contig.df$conserved.phylum.50) &
                                                         is.na(contig.df$conserved.kingdom.50),
                                                         "novel.in.Ac",
                                                         NA)))))
                             ...
                             ifelse(contig.df$conserved.clade.80%in%TRUE &
                                    ...
                                    ifelse(contig.df$conserved.clade.80%in%TRUE &
                                           ...
                                           ifelse(contig.df$conserved.clade.80%in%FALSE &
                                                  ...
                                                  contig.df$conserved.kingdom.80%in%FALSE,
                                                  "novel.in.clade3",
                                                  ifelse(is.na(contig.df$conserved.clade.80) &
                                                         is.na(contig.df$conserved.phylum.80) &
                                                         is.na(contig.df$conserved.kingdom.80),
                                                         "novel.in.Ac",
                                                         NA)))))
